        ...
        <div className="container">
          ...
          <div className="cert-grid">
            {ALL_CERTIFICATIONS.map((cert) =>
              cert.image ? (
                <button key={cert.title} type="button" className="cert-card certificate-item" onClick={() => onOpenCertificate(cert.image)}>
                  <p className="cert-title">{cert.title}</p>
                  <p className="cert-issuer">{cert.issuer}</p>
                </button>
              ) : (
                <a key={cert.title} className="cert-card" href={cert.href} target="_blank" rel="noopener noreferrer">
                  <p className="cert-title">{cert.title}</p>
                  <p className="cert-issuer">{cert.issuer}</p>
                </a>
              )
